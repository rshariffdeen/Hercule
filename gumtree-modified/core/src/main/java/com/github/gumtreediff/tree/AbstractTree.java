...
public abstract class AbstractTree implements Tree {
    ...
    public abstract void setStartLine(int startLine);
    ...
    public String toString() {
        if (hasLabel())
            return String.format("%s: %s [%d,%d,%d,%d]",
                    getType(), getLabel(), getPos(), getEndPos(),getStartLine(),getEndLine());
        else
            return String.format("%s [%d,%d,%d,%d]",
                    getType(), getPos(), getEndPos(),getStartLine(),getEndLine());
    }
