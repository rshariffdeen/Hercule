...
public class FakeTree extends AbstractTree {
    ...
    {
        return Collections.min(children, (t1, t2) -> t2.getStartLine() - t1.getStartLine()).getStartLine();
    }

    @Override
    public int getEndLine()
    {
        return Collections.max(children, (t1, t2) -> t2.getEndLine() - t1.getEndLine()).getEndLine();
    }
